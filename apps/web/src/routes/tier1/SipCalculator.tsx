...
export function SipCalculator() {
  ...
  const result = useMemo(() => {
    ...
    return { nominalFV, realFV, totalInvested, wealthGain: nominalFV - totalInvested, solvedMonthlyContribution };
  ...
  return (
    ...
    >
      ...
      {result && (
        <section className="mt-14 flex max-w-md flex-col gap-8" aria-label="SIP result">
